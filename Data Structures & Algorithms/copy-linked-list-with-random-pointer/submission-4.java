...
class Solution {
    ...
    * -however, it has a unique property of containing an
    *  additional pointer random, which may point to 
    *  another node in the list, or null
    *
    * return a deep copy of the list
    *
    * to solve this question, we can use a 3-phase approach:
    * 1. interweave the copied nodes in original list
    *
